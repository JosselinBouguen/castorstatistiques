...
import 'package:castorstatistics/widgets/liquid_script.dart' show liquidScript;
import 'package:castorstatistics/widgets/gl_script.dart' show glScript;
...
class _ChartPageState extends State<ChartsPage> {
        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              Padding(
                child: Text('Nombre de services cette année', style: TextStyle(fontSize: 20)),
                  ...
                  option: '''
                    {
                      ...
                      yAxis: {
                        ...
                        splitArea: {
                          show: true,
                          areaStyle: {
                            color: ['rgb(224, 224, 235)', 'rgba(250,250,250,0.05)'],
                          },
                        },
                      },
                      series: [{
                          ...
                          normal: {
                            ...
                            color: {
                              ...
                              colorStops: [
                                ...
                                {
                                  offset: 1, color: 'rgb(153, 255, 153)',
                                },
                                {
              ...
              Padding(
                child: Text('Graphique 3000', style: TextStyle(fontSize: 20)),
              ...
              Padding(
                child: Text('Proportion des catégories cette semaine', style: TextStyle(fontSize: 20)),
                padding: EdgeInsets.fromLTRB(0, 40, 0, 0),
              ),
              Container(
                child: Echarts(
  ...
  legend: {
    data: ['Transport', 'Courses', 'Tâches ménagères', 'Loisirs', 'Formations']
  },
  toolbox: {
    feature: {
      saveAsImage: {}
