class MeditationSvgAssets {
  ...
  Map<AssetName, String> assets = {
    ...
    AssetName.transport: "assets/icons/transport.svg",
    AssetName.course: "assets/icons/course.svg",
    AssetName.formation: "assets/icons/formation.svg",
    AssetName.loisir: "assets/icons/loisir.svg",
    AssetName.tache: "assets/icons/tache.svg",
